...
//  initial composite with the pre-fire set to one year     //
//  before the fire and the post-fire the same year as      //
//  the fire. The compositing criterion is the max-min      //
//                                                          //
...
//  GEE link: https://code.earthengine.google.com/3ada2f6d90d5f5dd5a02135065df94b1
//                                                          //
//                                                          //
//  License: MIT License                                    //
...
var get_severity = function(fire) {
  ...
  // and selecting images during the summer period (DOY 153-274). Use quality mosaic to select the best pixels.
...
for (var year = year_start; year <= year_end; year++) {
  ...
  Export.image.toDrive({
    ...
    description: 'Initial_max_min_' + year,
    folder: 'Your_folder',
    maxPixels: 1e13,
    scale: 30
  });
